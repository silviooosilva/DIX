...
<div class="col-md-10 text-center ml-auto mr-auto">
    <h3 class="mb-5">Welcome to my solution to the CRUD challenge</h3>
    <h2>By: Sílvio Silva</h2>
</div>
    ...
    <form class="form" method="post" action="{{ route('login') }}">
        ...
        <div class="card card-login card-white">
            <div class="card-header">
                ...
                <h1 class="card-title ml-2">{{ _('Log in') }}</h1>
            </div>
            <div class="card-body">
                <p class="text-dark mb-2">Sign in or create an account</p>
